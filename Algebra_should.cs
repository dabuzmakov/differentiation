...
public class Algebra_should
{
    ...
    [Test] public void DifferentiateLog()
        => AssertDerivativeEqualToNumericDerivative(z => Math.Log(z * z + 1, 3));

    [Test] public void DifferentiateTan() 
		=> AssertDerivativeEqualToNumericDerivative(z => Math.Tan(z * z + 132));

    [Test] public void DifferentiateTanOfComplex() 
		=> AssertDerivativeEqualToNumericDerivative(z => Math.Tan(z * z + Math.Sin(z)));

    [Test] public void DifferentiateSumAndProductWithSubtraction()
        => AssertDerivativeEqualToNumericDerivative(z => 5 * z - z * z + 3);

    [Test] public void DifferentiateAbsLinear()
		=> AssertDerivativeEqualToNumericDerivative(z => Math.Abs(3 * z - 2));
    ...
    [Test] public void DifferentiateNestedFunctions()
        => AssertDerivativeEqualToNumericDerivative(z =>
